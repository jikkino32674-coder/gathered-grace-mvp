            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mt-4">
                  This elegant hardcover notebook and coordinating pen invite moments of pause — to jot down thoughts, prayers, or notes of gratitude.
                </p>
              </div>
...
export default JournalPenDetails;
